...
import com.example.xiangmm.beans.zhihu.zhi.CommentBean;
import com.example.xiangmm.beans.zhihu.zhi.DailyBeforeListBean;
import com.example.xiangmm.beans.zhihu.zhi.DailyListBean;
import com.example.xiangmm.beans.zhihu.zhi.DetailExtraBean;
import com.example.xiangmm.beans.zhihu.zhi.HotListBean;
import com.example.xiangmm.beans.zhihu.zhi.SectionChildListBean;
import com.example.xiangmm.beans.zhihu.zhi.SectionListBean;
import com.example.xiangmm.beans.zhihu.zhi.ThemeChildListBean;
import com.example.xiangmm.beans.zhihu.zhi.ThemeListBean;
import com.example.xiangmm.beans.zhihu.zhi.ZhihuDetailBean;
...
public interface ZhihuApis {
     ...
     */
    @GET("start-image/{res}")
    Observable<String> getWelcomeInfo(@Path("res") String res);
